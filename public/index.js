...
function about()
{
w=open('','A propos de nous : ','left=45, top=45,width=350,height=200,resizable=no');
w.document.write("<br /><br /> Nous sommes 4 jeunes étudiants en développement web, et nous avons pour ambition de vendre des marguerites aux Emirats Arabes.");
w.document.write("</body>");
w.document.close();
} 
function confi()
{
w=open('','Charte de Confidentialité','width=350,height=200,resizable=no');
w.document.write("Nous sommes un site respecant la toute nouvelle loi RGPD");
w.document.write("</body>");
w.document.close();
} 